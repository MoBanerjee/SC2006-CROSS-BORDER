...
import '../styles/T&C.css'; // Ensure this path is correct
import Logo from '../assets/landscapelogo.png'; // Ensure this path is correct
  ...
  return (
    <div className="TandC-container">
      <header className="TandC-header">
        <img src={Logo} alt="CROSS BORDER Emblem" className="TandC-logo" />
