  ...
  return (
    ...
    >
      ...
      <Autocomplete onLoad={handleLoadStart}>
        ...
        <button onClick={handleSelectCurrentLocationStart}>Use Current Location</button>
        <Autocomplete onLoad={handleLoadDestination}>
          <input type="text" placeholder="Enter destination" onChange={handleDestInput} />
        </Autocomplete>
        <button onClick={() => fetchDirections(startLocation || origin, destination)}>Find Route</button>
      </div>
